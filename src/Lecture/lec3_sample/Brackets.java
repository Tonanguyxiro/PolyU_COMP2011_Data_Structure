...
/**
 * 
 * @author yixin cao (September 29, 2019)
 *
 * Methods for checking whether a sequence of brackets is balanced.
 * 
 * If there is one kind of brackets, a simple tally will work.
 * Otherwise, we use a {@code CharStack}.
 */
public class Brackets {
    ...
    public static boolean isMultipleBalanced(char[] s) {
        ...
        return stack.isEmpty(); // don't forget to check!
    }
